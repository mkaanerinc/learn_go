...
// `interface{}` is known as the **empty interface** in Go.
// It can hold a value of **any type** because every type implements zero methods,
// and the empty interface requires no methods.

// Since Go 1.18, a special alias `any` was introduced:
// `type any = interface{}`
// This makes it more readable and more idiomatic when you mean "any type".
